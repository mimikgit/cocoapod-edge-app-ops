...
///
/// \param completion Completion block returning a response string or Error.
///
- (void)updateGps:(NSString * _Nonnull)edgeAccessToken location:(CLLocation * _Nonnull)location completion:(void (^ _Nonnull)(NSString * _Nullable response, NSError * _Nullable error))completion;
